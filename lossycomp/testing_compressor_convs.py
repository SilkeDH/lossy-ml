...
for i in [0.0001, 0.001, 0.01, 0.1, 0.3, 0.5, 0.7, 1.0]:
    ...
    for index in range(nb_batches):
        ...
        compressed_data = compress(data_2, err_threshold=i, extra_channels = False,  method='mask', mode = 'None', convs = 3, hyp = 'models/3_convs' )
        ...
        # Model 3 convs
        compressed_data = compress(data_2, err_threshold=i, extra_channels = False,  method='mask', mode = 'None', convs = 5, hyp = 'models/5_convs' )
    ...
    pickle.dump({'conv_3': model_history_3, 'conv_4':model_history_4, 'conv_5':model_history_5}, open('results/output/CF_conv_3_4_5.pkl', 'wb'))
