...
def decompress(compressed_data, comp, extra_channels = True, verbose = False,  method='None', mode = 'None', convs = 4, hyp = 1):
    reset_random_seeds()
    ...
    if method == 'None':
        ...
        chunks_set = tf.data.Dataset.from_tensor_slices(comp)
        batch_size = 10
        ...
        return decompressed_data, mask_out, error_out, error, val, compressed_data, error_quan, decompressed_data2#, error